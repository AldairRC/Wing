...
var _categorias = require("../../Controladores/Negocios/categorias");
...
router.post('/insertar', upload.none(), _categorias.insertar); //=================================================
// RUTA PARA ELIMINAR UNA MARCA DE PRODUCTO EXISTENTE
//=================================================

router.post('/eliminar', upload.none(), _categorias.eliminar); //=================================================
// RUTA PARA BUSCAR MARCAS DE PRODUCTOS
//=================================================

router.post('/buscar', upload.none(), _categorias.buscar); //=================================================
// RUTA PARA ACTUALIZAR UNA MARCA
//=================================================

router.post('/actualizar', upload.none(), _categorias.actualizar);
var _default = router;
