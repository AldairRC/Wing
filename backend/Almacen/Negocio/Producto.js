...
var AlmacenProducto = /*#__PURE__*/function () {
  function AlmacenProducto() {
    (0, _classCallCheck2["default"])(this, AlmacenProducto);
  }

  (0, _createClass2["default"])(AlmacenProducto, null, [{
    key: "guardarImagen",
    value:
    /*===================================================
            GUARDAR IMAGEN DE UN PRODUCTO (return: nombre.ext )
    =====================================================*/
    function () {
      var _guardarImagen = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(imagenBase64, id_producto, tipoImagen, numImagen) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                _context.prev = 11;
                nombreImagen = 'producto_' + numImagen + "_" + id_producto + "." + tipoImagen;
                _context.next = 15;
                return s3.S3.putObject({
                  Bucket: AlmacenProducto.UBICACION,
                  ACL: 'private',
                  //'public-read' ,
                  Key: nombreImagen,
                  Body: dataImagen,
      ...
      function guardarImagen(_x, _x2, _x3, _x4) {
    ...
    /*===================================================
            OBTENER LA IMAGEN DE UN PRODUCTO (return:  EL BASE64 URL Y EL TIPO )
    =====================================================*/
...
exports["default"] = AlmacenProducto;
(0, _defineProperty2["default"])(AlmacenProducto, "UBICACION", _config.configAWS.bucketName + "/Negocios/Productos");