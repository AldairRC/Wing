...
var AlmacenMarca = /*#__PURE__*/function () {
  function AlmacenMarca() {
    (0, _classCallCheck2["default"])(this, AlmacenMarca);
  }

  (0, _createClass2["default"])(AlmacenMarca, null, [{
    key: "guardarImagen",
    value:
    /*===================================================
            GUARDAR IMAGEN DE UNA MARCA
            (return:  LA RUTA DE LA IMAGEN )
    =====================================================*/
    function () {
      var _guardarImagen = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(imagenBase64, id_marca, tipoImagen) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                _context.prev = 11;
                nombreImagen = 'marca_' + id_marca + "." + tipoImagen;
                _context.next = 15;
                return s3.S3.putObject({
                  Bucket: AlmacenMarca.UBICACION,
                  ACL: 'private',
                  //'public-read' ,
                  Key: nombreImagen,
                  Body: dataImagen,
    ...
    /*===================================================
            OBTENER LA IMAGEN DE UNA MARCA
            (return:  EL BASE64 URL Y EL TIPO )
    =====================================================*/
...
exports["default"] = AlmacenMarca;
(0, _defineProperty2["default"])(AlmacenMarca, "UBICACION", _config.configAWS.bucketName + "/Negocios/Marcas");
(0, _defineProperty2["default"])(AlmacenMarca, "ERROR", 1);
(0, _defineProperty2["default"])(AlmacenMarca, "OK", 0);